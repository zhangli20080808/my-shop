	...
	render = () => {
		return (
			<div className="about-section">
				<h2 className="help-s2-title">注册协议</h2>
				<div className="help-inner">
					...
					<div className="help-sec">
						<p>5.
							用户在注册时应当选择稳定性及安全性相对较好的电子邮箱，并且同意接受并阅读本网站发往用户的各类电子邮件。如用户未及时从自己的电子邮箱接受电子邮件或因用户电子邮箱或用户电子邮件接收及阅读程序本身的问题使电子邮件无法正常接收或阅读的，只要本网站成功发送了电子邮件，应当视为用户已经接收到相关的电子邮件。电子邮件在发信服务器上所记录的发出时间视为送达时间</p>
					</div>
					<div className="help-sec">
						<p>6．服务条款的修改</p>
					...
					<div className="help-sec">
						<p>14．结束服务</p>
						<p>服务。用户若反对任何服务条款的建议或对后来的条款修改有异议，或对本网站服务不满，用户可以行使如下权利：</p>
						<p>(1) 不再使用本网站信息服务。</p>
					...
					<div className="help-sec">
						<a className="help-btn" href="/user/register">去注册 &gt;</a>
					</div>
				</div>
			</div>
		)
